...
class TestAddFuel:
    def test_basic(self, capsys):
        ...
        assert out["subsidy_amount"] == round(bookkeeper.LPG_SUBSIDY_PER_LITER * 50)
        assert out["net_cost"] == 50000 - round(bookkeeper.LPG_SUBSIDY_PER_LITER * 50)
    ...
    def test_subsidy_calculation(self, capsys):
        ...
        expected_subsidy = round(bookkeeper.LPG_SUBSIDY_PER_LITER * 40)
...
class TestIntegration:
    def test_full_day_workflow(self, capsys):
        ...
        fuel_subsidy = round(bookkeeper.LPG_SUBSIDY_PER_LITER * 45)
